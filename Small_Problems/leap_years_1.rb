...
# unless the year is also divisible by 100. If the year is evenly divisible by 100, then it is not a leap year unless the year
# is evenly divisible by 400. 
# Assume this rule is good for any year greater than 0. Write a method that takes any year greater than 0 as input, and returns 
